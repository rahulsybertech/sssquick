...
class GradeAdapter(
    ...
    purchasePartyData: List<GradeItem>,
)
    : ArrayAdapter<GradeItem>(mContext, mLayoutResourceId, purchasePartyData) {

    private val purchaseParty: MutableList<GradeItem> = ArrayList(purchasePartyData)
    private var allPurchaseParty: List<GradeItem> = ArrayList(purchasePartyData)
    ...
    override fun getItem(position: Int): GradeItem = purchaseParty[position]
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            ...
            override fun performFiltering(constraint: CharSequence?): FilterResults {
                ...
                if (constraint != null) {
                    val purchasePartySuggestion: MutableList<GradeItem> = ArrayList()
