...
class HoldOrderPDFListAdapter(private val pdfs: List<PendingOrderItem.PdfPath>?, val mCallBack: (String) -> Unit) : RecyclerView.Adapter<HoldOrderPDFListAdapter.MyViewHolder>() {
