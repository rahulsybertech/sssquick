...
import com.ssspvtltd.quick.ui.AddOrderActctivity
...
import java.net.URL
@AndroidEntryPoint
class PendingOrderCustomerDetailsBottomSheetFragment : BaseBottomDialog<FragmentPendingOrderDetailsBottomSheetBinding, BaseViewModel>() {
    ...
    private fun initViews() = with(binding) {
        ...
        binding.regeneratedPdf.setOnClickListener {
            val pendingOrderPDFRegenerateRequest =
                com.ssspvtltd.quick.model.order.pending.PendingOrderPDFRegenerateRequest.PendingOrderPDFRegenerateRequestItem(
   ...
   //         btnEdit.visibility = android.view.View.VISIBLE
        ...
        btnEdit.setOnClickListener {
          ...
          /*  val bundle = Bundle().apply {
                putString(com.ssspvtltd.quick.model.ARG_PENDING_ORDER_ID, pendingOrderItem?.orderID)
            }
            val navOptions = androidx.navigation.NavOptions.Builder()
                .setPopUpTo(com.ssspvtltd.quick.R.id.pendingorderFragment, false)
                .build()
            findNavController().navigate(com.ssspvtltd.quick.R.id.addOrderFragment, bundle, navOptions)*/
                val intent = Intent(requireContext(), AddOrderActctivity::class.java).apply {
                    putExtra(ARG_PENDING_ORDER_ID, pendingOrderItem?.orderID)
                }
    ...
    companion object {
        ...
        fun newInstance(pendingOrderItem: PendingOrderItem): PendingOrderCustomerDetailsBottomSheetFragment {
            return PendingOrderCustomerDetailsBottomSheetFragment().apply {
