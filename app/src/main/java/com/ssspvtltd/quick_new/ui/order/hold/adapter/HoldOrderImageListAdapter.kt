...
class HoldOrderImageListAdapter(private val imgs: List<com.ssspvtltd.quick_new.model.order.hold.HoldOrderItem.ImagePath>?, val mCallBack: (String) -> Unit) : RecyclerView.Adapter<HoldOrderImageListAdapter.MyViewHolder>() {
