package com.ssspvtltd.quick_app.widgets
...
import com.ssspvtltd.quick_app.databinding.IncludeToolbarBinding
    ...
    private fun initView(attrs: AttributeSet?) {
        if (attrs != null) {
            ...
            try {
                ...
                val title       = ta.getString(R.styleable.AppToolbar_title) ?: resources.getString(R.string.app_name)

                val isNotificationVisible   = ta.getBoolean(R.styleable.AppToolbar_isNotificationVisible, false)
                val isLocationVisible       = ta.getBoolean(R.styleable.AppToolbar_isLocationVisible, false)
                val isLogoutVisible         = ta.getBoolean(R.styleable.AppToolbar_isLogoutVisible, false)
